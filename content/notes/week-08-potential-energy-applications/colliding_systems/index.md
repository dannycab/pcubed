...
title: "Collisions"
weight: 6
textbook_ref: "Section 10.1, 10.2, 10.3 and 10.4 in Matter and Interactions (4th edition)"
---

Collisions occur everywhere around you. Right now, molecules of gas are constantly colliding with each other in the air that surrounds you as well as colliding with your clothes and skin. **In the notes, you will read about how to analyze collisions using the [momentum principle](/notes/week-02-modeling-motion-net-force/momentum_principle/) and [energy principle](https://www.msuperl.org/wikis/pcubed/doku.php?id=183_notes:energy_cons).** You will also read about different kinds of collisions. Later you will read how collisions lead to the [discovery of the nucleus](/notes/week-12-14-collisions-rotational-motion/discovery_of_the_nucleus/).

### Lecture Video

{{< youtube ZEsAuTpQ7B8 >}}

# Collisions & Conservation of Momentum & Energy
...
From the [multi-particle momentum principle](/notes/week-04-05-springs-contact-interactions/mp_multi/),
...
$$
\Delta{\overset{\rightarrow}{p}}_{sys} = \underset{\approx 0}{\underbrace{{\overset{\rightarrow}{F}}_{ext}\Delta t}}
$$
...
From the [energy principle](https://www.msuperl.org/wikis/pcubed/doku.php?id=183_notes:energy_cons),
...
$$
\Delta E_{sys} = \underset{\approx 0}{\underbrace{W_{surr}}} + \underset{\approx 0}{\underbrace{Q}}
$$
...
### The System Can Have Internal Energy

While the above discussion might make you conclude that the energy that is conserved is only kinetic (i.e., due to the motion), this is not the case. The total energy of the system is conserved, so you have to keep track of kinetic and [internal energy](/notes/week-10-internal-energy-heat/internal_energy/) during a collision. In fact, whether the system changes its internal energy is a part of understanding collisions.

### Collisions Can Occur Without Physical Contact
...
$$
\Delta E_{sys} = \Delta K_{sys} + \underset{\approx 0}{\underbrace{\Delta E_{internal}}} = 0
$$
...
$$
{\overset{\rightarrow}{p}}_{f,sys} = {\overset{\rightarrow}{p}}_{sys,i}
$$
